...
return this;},destroy:function(){}};AppSeeds.Permit={create:function(options){var _functions={};var _auth=[];var permit={allow:function(roleStr,originalFunction){var roles=roleStr.split(/\s+/),i,fId;if(typeof originalFunction==='function'){for(i in _functions){if(_functions.hasOwnProperty(i)&&_functions[i].func===originalFunction){fId=i;break;}}
